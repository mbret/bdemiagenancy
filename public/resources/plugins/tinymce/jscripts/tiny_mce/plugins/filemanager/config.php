<?php
        ...
        // Preview options
        $mcFileManagerConfig['preview.wwwroot'] = PUBLIC_PATH; // absolute or relative from this script path (c:/Inetpub/wwwroot).
        ...
        $mcFileManagerConfig['filesystem.rootpath'] = PUBLIC_PATH; // absolute or relative from this script path.
