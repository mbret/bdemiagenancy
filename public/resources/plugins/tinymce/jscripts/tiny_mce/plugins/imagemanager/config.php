<?php
	...
	// Preview options
	$mcImageManagerConfig['preview.wwwroot'] = PUBLIC_PATH; // absolute or relative from this script path, try to leave blank system figures it out.
	...
	$mcImageManagerConfig['filesystem.rootpath'] = PUBLIC_PATH;//'files'; // absolute or relative from this script path, required.
